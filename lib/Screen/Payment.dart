...
import 'package:transpo/Screen/AddPaymentCardScreen.dart';
        ...
        child: Stack(
          children: <Widget>[
            ...
            Positioned(
              ...
              children: [
                Text("Add new card",style: GoogleFonts.poppins(fontSize: 18,fontWeight: FontWeight.bold,color: AppColors.g),),
                ...
                },child: Icon(Icons.arrow_forward,color: Colors.white,),backgroundColor: AppColors.g,)
              ],
            ))
